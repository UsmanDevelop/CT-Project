...
function home() {
  ...
  return (
    <>
      ...
      >
        {/* <div className='h-full w-[90%] bg-radial-[at_80%_12%] from-[#48310f] to-30% absolute '></div> */}
        <div className="w-full h-full flex flex-col items-center align-bottom justify-center bg-radial-[at_20%_18%] from-[#1a0f06] to-20% md:flex-row md:justify-evenly ">
          ...
          <div className='mt-20 md:mt-0 z-20'>
            ...
            <Magnet padding={200} activeTransition="transform 1s ease-out" disabled={false} magnetStrength={10}>
